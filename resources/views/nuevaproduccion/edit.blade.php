...
@section('modal-footer')
    ...
    <a class="btn btn-sm btn-warning"
       href="{{route('nuevaproduccion.index',['id'=>$nuevaProduccion->ingresoProduccion->id])}}">Volver</a>
@endsection
{{-----------------------------------------------------------------}}
@section('modal')
...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form action="{{route('nuevaproduccion.update')}}" id="actualizarNuevaProduccion">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nro_guia_prod" class="form-control"
                                                   readonly
                                                   value="{{$nuevaProduccion->ingresoProduccion->nro_guia_ingreso}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nro_guia_nueva_produccion">Fecha- Hora Ingreso:</label>
                                            <input type="date" name="fecha_ingreso_produccion" class="form-control"
                                                   readonly
                                                   value="{{$nuevaProduccion->ingresoProduccion->fecha}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="hidden" name="ingreso_produccion_id"
                                               value="{{($nuevaProduccion->ingresoProduccion->id)}}">

                                        <input type="hidden" name="nueva_produccion_id"
                                               value="{{($nuevaProduccion->id)}}">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nro_guia_nueva_produccion" class="form-control"
                                                   readonly
                                                   value="{{$nuevaProduccion->nro_guia_salida}}">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-inline">
                                            <div class="form-group">
                                                <input type="date" value="{{$nuevaProduccion->fecha}}"
                                                       class="form-control" name="fecha">
                                                <input type="time" value="{{$nuevaProduccion->hora}}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nro_campana" class="form-control" readonly
                                                   value="{{$nuevaProduccion->ingresoProduccion->lote->compania}}">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        @isset($nuevaProduccion->ingresoProduccion->lote->agricultor)
                                            <label for="agricultor">Agricultor :</label>
                                            <input type="text" name="agricultor" class="form-control" readonly
                                                   value="{{$nuevaProduccion->ingresoProduccion->lote->agricultor->apellidos.' '.$nuevaProduccion->ingresoProduccion->lote->agricultor->nombres}}">
                                            @else
                                                <label for="empresa">Empresa :</label>
                                                <input type="text" name="empresa" class="form-control" readonly
                                                       value="{{$nuevaProduccion->ingresoProduccion->lote->empresa->razon_social}}">
                                                @endisset
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="variedad" class="form-control" readonly
                                                   value="{{$nuevaProduccion->ingresoProduccion->lote->variedad->descripcion}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="origen" class="form-control" readonly
                                                   value="{{$nuevaProduccion->ingresoProduccion->area_origen}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="" value="{{$nuevaProduccion->ingresoProduccion->kilo_por_saco}}" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                   name="nro_sacos_stock_inicial" value="{{$nuevaProduccion->nro_sacos_stock_inicial}}" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step="any" value="{{$nuevaProduccion->kilos_total_inicial}}"
                                                                   name="kilos_totales_stock_inicial"
                                                                   class="form-control" readonly>
                                                            <input type="hidden" value="{{$nuevaProduccion->ingresoProduccion->kilo_por_saco}}" name="kilo_por_sacos">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="nro_sacos_procesar" class="control-label">Nro
                                                                ...
                                                                <input type="number" step="any" value="{{$nuevaProduccion->nro_sacos_a_procesar}}"
                                                                       name="nro_sacos_procesar" class="form-control"
                                                                       min="0" max="{{$nuevaProduccion->ingresoProduccion->nro_sacos_ingresados}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                            <input type="number" step="any" value="{{$nuevaProduccion->kilos_a_procesar}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$nuevaProduccion->nro_sacos_saldo}}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                            <input type="number" step="any" value="{{$nuevaProduccion->kilos_total_saldo}}"
                                ...
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="producto" id="" class="form-control input-sm">
                                            <option value="">Arroz Añejo</option>
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <input type="number" class="form-control input-sm" name="sacos_kilos" value="0">
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <label for="precio_maquila">Precio Maquila</label>
                                        <div class="input-group">
                                            <div class="input-group-addon">S/</div>
                                            <input type="number" class="form-control input-sm" name="precio_maquila" value="0">
                                        </div>
                                    </div>
                                    <div class="col-md-2 form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-responsive table-hover table-condensed small box text-center " id="tabla">
                        ...
                        <tbody>
                            {{--@foreach($nuevaProduccion->resultadoProduccion as $resultado)--}}
                                {{--<tr>--}}
                                    ...
                                    {{--<td>{{$resultado->sub_total_maquila}}</td>--}}
                                    {{--<td>{{$resultado->sub_total_envase}}</td>--}}
                                    {{--<td><button class="btn btn-danger btn-xs quitar" index="$index"><span class="glyphicon glyphicon-remove"></span> Quitar</button></td>--}}
                                {{--</tr>--}}
                            {{--@endforeach--}}
                        </tbody>
                    </table>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{route('nuevaproduccion.index',['id'=>$nuevaProduccion->ingresoProduccion->id])}}"
