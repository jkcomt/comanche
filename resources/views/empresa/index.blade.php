...
@section('content')
    @include('empresa.modals.edit')

    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                <a href="{{route('empresa.nuevo')}}" class="btn btn-success">NUEVA EMPRESA</a>
            </div>
        </div>
        <div class="col-md-10">
            <form action="" class="form-inline text-right">
                <input type="text" id="buscarEmpresa" placeholder="BUSCAR..." class="form-control">
