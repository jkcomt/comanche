...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form action="{{route('personal.create')}}" method="POST" id="registrarPersonal">
                {{csrf_field()}}
                ...
                <div class="form-group col-md-12">
                    ...
                    <a href="{{route('personal.index')}}" class="btn btn-warning " id="index">Volver</a>
                </div>
