<div class="modal fade" tabindex="-1" role="dialog" id="modal-vehiculo-nuevo">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="registrarVehiculo" action="{{route('vehiculo.create')}}" method="post" >
                    {{csrf_field()}}
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="submitRegistrarVehiculo">Registrar</button>
