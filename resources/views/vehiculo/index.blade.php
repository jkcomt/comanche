...
@section('content')
    @include('vehiculo.modals.edit')

    <div class="row">
            <div class="col-md-2">
                <div class="form-group ">
                <a href="{{route('vehiculo.nuevo')}}" class="btn btn-success">NUEVO VEHÍCULO</a>
                </div>
            </div>
            <div class="col-md-10">
                <form action="" class="form-inline text-right">
                    <input type="text" id="buscarVehiculo" placeholder="BUSCAR..." class="form-control">
