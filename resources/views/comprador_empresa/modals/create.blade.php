<div class="modal fade" tabindex="-1" role="dialog" id="modal-comprador-empresa-nuevo">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="registrarCompradorEmpresa" action="{{route('comprador_empresa.create')}}" method="post">
                    {{csrf_field()}}
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="submitRegistrarCompradorEmpresa">Registrar</button>
