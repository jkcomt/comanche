...
@section('content')
    @include('comprador_empresa.modals.edit')

    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                <a href="{{route('comprador_empresa.nuevo')}}" class="btn btn-success">NUEVA EMPRESA</a>
            </div>
        </div>
        <div class="col-md-10">
            <form action="" class="form-inline text-right">
                <input type="text" id="buscarCompradorEmpresa" placeholder="BUSCAR..." class="form-control">
    ...
    <div class="row"  id="tabla">
        @include('comprador_empresa.tabla')
    </div>
@endsection
@section('script')
