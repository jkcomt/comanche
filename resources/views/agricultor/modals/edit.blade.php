<div class="modal fade" tabindex="-1" role="dialog" id="modal-agri-edit">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Editar Agricultor</h4>
            </div>
            <div class="modal-body">
                <form id="agri-frm-update" action="{{route('agricultor.update')}}" method="post" id="editarAgricultor">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="celular" value="{{old('celular')}}" maxlength="20">
                    </div>
