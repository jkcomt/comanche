<div class="modal fade" tabindex="-1" role="dialog" id="modal-agri-nuevo">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Nuevo Agricultor</h4>
            </div>
            <div class="modal-body">
                <form id="registrarAgricultor" action="{{route('agricultor.create')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ruc" value="{{old('ruc')}}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="submitRegistrarAgricultor">Registrar</button>
