...
@section('content')
    @include('agricultor.modals.edit')

    <div class="row">
            <div class="col-md-2">
                <div class="form-group">
                <a href="{{route('agricultor.nuevo')}}" class="btn btn-success">NUEVO AGRICULTOR</a>
                </div>
            </div>
            <div class="col-md-10">
                <form action="" class="form-inline text-right">
                    <input type="text" id="buscarAgricultor" placeholder="BUSCAR..." class="form-control">
