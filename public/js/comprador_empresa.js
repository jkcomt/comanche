...
$('#registrarCompradorEmpresa').submit(function(event)
{
    event.preventDefault();
...
$('body').on('click','.edit',function(e){
    ...
    var url = "/comprador_empresa/"+id+"/edit"
    $.ajax({
        type:"get",
        url:url,
        dataType:"json",
        ...
        success: function(data){
            ...
            $('#modal-comprador-empresa-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#comprador-empresa-frm-update').attr('action');
    ...
    $.ajax({
        ...
        success: function(data){
            $('#modal-comprador-empresa-edit').modal('hide');
            location.reload();
...
$('.confirmar').on('click',function (e) {
    ...
    var url = "/comprador_empresa/delete"
...
$('#buscarCompradorEmpresa').on('keyup',function(){
    valor = $(this).val()

    // e.preventDefault();
    var token = $('input[name=_token]').attr('value')

    var url = "/comprador_empresa/buscar"
    $.ajax({
        type:"get",
        headers: {'X-CSRF-TOKEN':token},
        url:url,
