...
$('#registrarResponsable').submit(function(event)
{
    event.preventDefault();
...
$('body').on('click','.edit',function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-responsable-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#responsable-frm-update').attr('action');
    ...
    $.ajax({
        ...
        success: function(data){
            $('#modal-responsable-edit').modal('hide');
            location.reload();
